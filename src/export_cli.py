...
Usage:
    python -m src.export_cli store.db output_dir --mode dump
    python -m src.export_cli store.db output_dir --mode files
    python -m src.export_cli store.db output_dir --mode both
"""
...
Examples:
  ...
  python -m src.export_cli my_store.db ./export --mode dump
  
  # Reconstruct original files
  python -m src.export_cli my_store.db ./export --mode files
  
  # Do both
  python -m src.export_cli my_store.db ./export --mode both
        """
    )
