"""
curate_tools/stats_report.py — Example drop-in curation tool.
...
# Import from the studio module where BaseCurationTool lives
from ..studio import BaseCurationTool, BG, BG2, FG, FONT_SM
